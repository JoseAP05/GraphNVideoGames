...
namespace LIVE_DEMO
{
    public class Rasterization
    {
        ...
        private void Init(Size size)
        {
            ...
            bits = new byte[stride * canvas_height]; 
        ...
        public void ComputePlanes(float fov)
        {
            ...
            camera.clipping_planes.Add(new Plane(new Vertex(0, 0, 1), 0));  
            camera.clipping_planes.Add(new Plane(left,0));  
            camera.clipping_planes.Add(new Plane(right, 0));  
            camera.clipping_planes.Add(new Plane(top, 0));  
            camera.clipping_planes.Add(new Plane(bottom, 0));  
        }
