...
namespace Scroll
{
    public partial class MAIN : Form
    {
        ...
        SoundPlayer sPlayer;
        SoundPlayer swing = new SoundPlayer(Resource2.sword_5);
        SoundPlayer jump = new SoundPlayer(Resource2.brkn_wand_jump);
        ...
        public void Init()
        {
            ...
            sPlayer = new SoundPlayer(Resource2.accordion_sting_03);
            player              = new Player();
            nail = new Nail();
