...
namespace Scroll
{
    public class Map
    {
        ...
        public int width = Resource2.City_of_tears.Width;


        public Map(Size size)
        {            
            
            soundPlayer = new SoundPlayer(Resource2.enemy_damage);            
            score = 0;
            layer1 = Resource2.City_of_tears;
            l1_x1 = l2_x2 = 0;
            l1_x2 = l2_x2 = width;
                ...
                for (int y = -1; y < nVisibleTilesY + 2; y++)
                {
                    ...
                    switch (c)
                    {
                        case '.':
                            ...
                            break;
                        case 'l':
                            g.DrawImage(Resource2.shade, stepX, stepY, nTileWidth, nTileHeight);
                            break;
                        case '#':
                            g.DrawImage(Resource2.plat, stepX, stepY, nTileWidth, nTileHeight);
                            break;
                        case 'B':
                            g.DrawImage(Resource2.Tile_HK, stepX, stepY, nTileWidth, nTileHeight);
                            break;
                        case '*':
                            g.DrawImage(Resource2.aspid, stepX, stepY, nTileWidth, nTileHeight);
                            break;
                        case 'f':
                            g.DrawImage(Resource2.Husk, stepX, stepY, nTileWidth, nTileHeight);
                            break;
                        case 'g':
                            g.DrawImage(Resource2.pillar, stepX, stepY, nTileWidth, nTileHeight);
                            break;
                        default:
                            g.DrawImage(Resource2.Tile_HK, stepX, stepY, nTileWidth, nTileHeight);//heavy
                            break;
                    }
